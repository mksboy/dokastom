...
if ($mode === 'checkout') {
    if (isset($_REQUEST['isChecked'])) {
        $ds_data = $_REQUEST['product_id'];
        if ($ds_data === 'ds_inn') {
            $innArray = [
                19 => [
                    "payment_id" => 19,
            ...
            Tygh::$app['view']->assign('isChecked', $ds_data);
//            Tygh::$app['view']->assign('payment_methods', $innArray);
//            Tygh::$app['view']->display('views/checkout/components/steps/payment.tpl');
        } elseif ($ds_data === 'ds_private') {
            $privateArray = [
                19 => [
                    "payment_id" => 19,
                    "company_id" => 1,
